...
import { Provider, Flex, Image, Text, Button, Header, List } from "@fluentui/react-northstar";
...
import { Person, FileList, Agenda, PersonViewType, PeoplePicker, PersonCardInteraction, MgtTemplateProps, Get } from '@microsoft/mgt-react';
